...
# 3 Linear Models - Models on Carbon offset  
...
## 3.1 model 1, dependent variables are:  
...
## 3.2 model 2, dependent variables are:  
1. total solar energy generation potential  
2. total number of solar panels  
3. region  
...
## 3.3 model 3, dependent variables are:  
1. total solar energy generation potential  
2. total number of solar panels  
3. regions  
...
## 3.4 model 4, dependent variables are:  
1. total solar energy generation potential  
2. regions  
...
## 3.5 vif tests of the four models:
```{r,results='markup'}
vif(fit1)
