...
mean_energy_per_west_panel_plot = 
      ggplot(data = citydf1, 
                 aes(x = mean_energy_per_west_panel)) +
        geom_histogram(col = "red", fill = "black", alpha = 0.7) +
...
#flat panel
mean_energy_per_flat_panel_plot = 
      ggplot(data = citydf1, 
                 aes(x = mean_energy_per_flat_panel)) +
        geom_histogram(col = "red", fill = "black", alpha = 0.7) +
...
total_sun_west = lm(sunlight_total ~ sunlight_west, data2=citydf1)
