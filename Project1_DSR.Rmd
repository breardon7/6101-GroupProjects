...
region_kw_total = ggplot(citydf1, aes(x = region, y = kw_total, col = region)) +
                    ...
                    labs(title = "Kw generation Total VS Region", y = "Kw gerneration Total (Kw)")
region_kw_total

region_carbon_offset = ggplot(citydf1, aes(x = region, y = carbon_offset, col = region)) +
                    geom_boxplot() + ylim(0, 0.3e+06)+
                    labs(title = "Carbon Offset VS Region", y = "Carbon Offset")
...
solar_panels_region = ggplot(sumpanels_luffy, 
                      ...
                      theme(axis.ticks.x=element_blank(),
                       ...
                       labs(title = "Total Number of Solar Panels (per direction) VS Region",
...
region_plot <- ggplot(citydf1_long,aes(x=region,y=value,fill=variable)) +  geom_boxplot() + facet_grid(.~region, scales="free") +  labs(title = "region,roof and sunlight",x="region",y="sunlight") + theme(plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(0,1e+08)) + scale_fill_manual(values = c("red","yellow","blue","green","white"))
region_plot  
...
region_sun_total + geom_boxplot() + scale_fill_manual(values = c("red","yellow","blue","green")) + labs(title = "region and total sunlight",x="region",y="total sunlight") + theme(plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(0,1e+09))
