...
``` {r}
fit1 <- lm(citydf1$carbon_offset ~ citydf1$sunlight_total + citydf1$panels_total)
summary(fit1)
par(mfrow=c(2,2))
plot(fit1)
...
``` {r}
fit2 <- lm(citydf1$carbon_offset ~ citydf1$sunlight_total + citydf1$panels_total + citydf1$region)
summary(fit2)
par(mfrow=c(2,2))
plot(fit2)
...
``` {r}
fit3 <- lm(citydf1$carbon_offset ~ citydf1$sunlight_total + citydf1$panels_total + citydf1$region + citydf1$panels_flat)
summary(fit3)
par(mfrow=c(2,2))
plot(fit3)
...
best model out of 4
``` {r}
fit4 <- lm(citydf1$carbon_offset ~ citydf1$sunlight_total + citydf1$panels_total + citydf1$region + citydf1$panels_flat + citydf1$panels_north + citydf1$panels_south + citydf1$panels_east + citydf1$panels_west)
summary(fit4)
par(mfrow=c(2,2))
plot(fit4)
...
vif(fit4)
```
Since model 4 has linearly dependent variables we remove `panels_total` from the model and we do vif test again.  
```{r}
fit5 <- lm(citydf1$carbon_offset ~ citydf1$sunlight_total + citydf1$region + citydf1$panels_flat + citydf1$panels_north + citydf1$panels_south + citydf1$panels_east + citydf1$panels_west)
vif(fit5)
```
