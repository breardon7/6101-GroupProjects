...
```
``` {r}
# Look at effect of directional facing buildings per different longitude/latitude (Cities in the north might have higher energy generation potential from south facing, and vice versa.)
...
south_us_city = subset(citydf1, lat_min <39.5)
