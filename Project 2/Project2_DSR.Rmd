...
koi_train_dis <- koi_df1[koi_sample==1, -2]
koi_test_dis <- koi_df1[koi_sample==2, -2]
koi_train_pdis <- koi_df1[koi_sample==1, -1]
koi_test_pdis <- koi_df1[koi_sample==2, -1]
koi_trainX <- koi_df1[koi_sample==1, 3:23]
koi_testX <- koi_df1[koi_sample==2, 3:23]
koi_trainLabels_dis <- koi_df1[koi_sample==1, 1]
koi_testLabels_dis <- koi_df1[koi_sample==2, 1]
koi_trainLabels_pdis <- koi_df1[koi_sample==1, 2]
koi_testLabels_pdis <- koi_df1[koi_sample==2, 2]
