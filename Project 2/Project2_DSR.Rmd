...
We use "0", "1" and "2" instead of the "FALSE POSITIVE", "CONFIRMED" and "CANDIDATE" to make it more convenient.
...
Now we finish the train-test split for the origin data with all features and the simplified data with less features.
