...
subtitle: "Sunroof Project Analysis"
author: "Team 4 - Data Science Rookies : Bradley Reardon, Pranay Bhakthula, Baldur Hua, Jichong Wu, Qinyuan Xing."
# date: "today"
date: "`r Sys.Date()`"
output:
  html_document:
...
**S.M.A.R.T Questions we would like to answer in this analysis:**  
...
### Barplots  
**Total Number of Solar Panels (per direction) By Region.**  
...
**carbon_offset vs panel directions (N,S,W,E and flat).**
```{r }
...
### Correlation Plot  
**Correlation plot of city dataset **  
...
## Model Building   
### Models on sunlight_total
**Linear model to determine effects of sunlight generation potential in all the directions on total sunlight generation potential.**  
...
**Linear models to determine effects of sunlight generation potential in all the directions on total sunlight generation potential in North and South section of USA separately.**  
``` {r, results='markup'}
...
**Anova tests on linear models to determine effects of sunlight generation potential in different directions individually on total sunlight generation potential.**  
...
### Models on Carbon offset  
**Linear models to determine effects of sunlight_total,panels_total,region and panels in all directions on `Carbon offset`.**

**model1, dependent variables are:**  
...
**model2, dependent variables are:**  
1. total solar energy generation potential  
2. total number of solar panels  
3. region  
...
**model3, dependent variables are:**  
1. total solar energy generation potential  
2. total number of solar panels  
3. regions  
...
**model4, dependent variables are:**  
1. total solar energy generation potential  
2. regions  
