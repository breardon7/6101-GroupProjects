...
```
From the histograms above, the mean solar energy absorbed in each position is right skewed distributed. Thus, the amount of energy per panel with the most frequency falls behind the overall mean in each position. 

The summary table generate the overall mean of the solar energy absorbed in each position. The south facing (mean of 328 kw/panel) the panel and flat panel (mean of 315 kw/panel) have the most solar energy absorbed (General mean of 310 kw/panel). This result indicates that the south facing panel and flat panel are the two position with the highest capability of solar energy absorption. 
...
The number of the solar panel is the potential data points that cities can provide. Overall, south region has the most number of installed solar panels. The second is west region which has the least number of cities counted. The least potential data points provider turns out to be the region with the second most of actual data points provided. 
